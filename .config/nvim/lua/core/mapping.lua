...
local core_map = {
	...
	["n|<A-h>"] = map_cr("vertical resize -2"):with_silent():with_desc("window: Resize -2 vertically"),
	["n|<A-l>"] = map_cr("vertical resize +2"):with_silent():with_desc("window: Resize +2 vertically"),
